...
To verify that all tracked Python files contain the correct copyright header for **TaskPilot Software Inc.** for the year **2023**, run this command from the repository root:
...
- **`-c "TaskPilot Software Inc."`**: sets the copyright holder.
