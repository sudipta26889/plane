    ...
    return (
      <Accordion.Root className="w-96">
        <Accordion.Item value="item-1">
          <Accordion.Trigger>What is TaskPilot?</Accordion.Trigger>
          <Accordion.Content>
            TaskPilot is an open-source project management tool designed for developers and teams to plan, track, and manage
        ...
        <Accordion.Item value="item-3">
          ...
          <Accordion.Content>
            TaskPilot offers both free and paid plans. The free plan includes essential features for small teams, while paid
