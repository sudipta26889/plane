...
export default {
  ...
  support: "サポート",
  forum: "Forum",
  powered_by_plane_pages: "Powered by TaskPilot Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        title: "プロジェクトを作成",
        description: "TaskPilotのほとんどはプロジェクトから始まります。",
        cta: "始める",
      },
      invite_team: {
        title: "チームを招待",
  ...
  workspace_creation: {
    heading: "ワークスペースを作成",
    subheading: "TaskPilotを使用するには、ワークスペースを作成するか参加する必要があります。",
    form: {
      name: {
        label: "ワークスペース名を設定",
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "TaskPilotへようこそ。ご利用いただき嬉しく思います。最初のプロジェクトを作成して作業項目を追跡すると、このページは進捗を把握するのに役立つスペースに変わります。管理者はチームの進捗に役立つ項目も表示されます。",
        primary_button: {
          text: "最初のプロジェクトを作成",
          comic: {
            title: "TaskPilotではすべてがプロジェクトから始まります",
  ...
  workspace_settings: {
    ...
    copy_key:
      "このシークレットキーをコピーしてTaskPilotページに保存してください。閉じた後はこのキーを見ることができません。キーを含むCSVファイルがダウンロードされました。",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          title: "APIトークンを削除",
          description:
            "このトークンを使用しているアプリケーションはTaskPilotのデータにアクセスできなくなります。この操作は取り消せません。",
          success: {
            title: "成功！",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "TaskPilotのAPIを使用して、TaskPilotのデータを外部システムと統合できます。トークンを作成して始めましょう。",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "新しい作業項目を作成して始めましょう！詳細とプロパティを追加してください。TaskPilotをさらに探索してアクティビティを確認しましょう。",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "TaskPilotは完了またはキャンセルされた作業項目を自動的にアーカイブします。",
        duration: "閉じられた作業項目を自動的にアーカイブ",
      },
      "auto-close": {
        title: "作業項目を自動的に閉じる",
        description: "TaskPilotは完了またはキャンセルされていない作業項目を自動的に閉じます。",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          text: "最初の作業項目を作成",
          comic: {
            title: "作業項目はTaskPilotの構成要素です。",
            description:
              "TaskPilotのUIの再設計、会社のリブランド、新しい燃料噴射システムの立ち上げなどは、サブ作業項目を持つ可能性が高い作業項目の例です。",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "メモ、ドキュメント、または完全なナレッジベースを作成しましょう。TaskPilotのAIアシスタントGalileoが開始をサポートします",
        description:
          "ページはTaskPilotの思考整理スペースです。会議のメモを取り、簡単に整形し、作業項目を埋め込み、コンポーネントライブラリを使用してレイアウトし、すべてをプロジェクトのコンテキストに保存できます。ドキュメントを素早く作成するには、ショートカットまたはボタンのクリックでTaskPilotのAI、Galileoを呼び出してください。",
        primary_button: {
          text: "最初のページを作成",
        },
      },
  ...
  self_hosted_maintenance_message: {
    taskpilot_didnt_start_up_this_could_be_because_one_or_more_taskpilot_services_failed_to_start:
      "TaskPilotが起動しませんでした。これは1つまたは複数のTaskPilotサービスの起動に失敗したことが原因である可能性があります。",
