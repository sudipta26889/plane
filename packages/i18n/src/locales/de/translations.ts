...
export default {
  ...
  auth: {
    common: {
      ...
      new_to_plane: "Neu bei TaskPilot?",
  ...
  support: "Support",
  forum: "Forum",
  powered_by_plane_pages: "Bereitgestellt von TaskPilot Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Die meisten Dinge beginnen mit einem Projekt in TaskPilot.",
        cta: "Los geht’s",
      },
      invite_team: {
        title: "Team einladen",
      ...
      personalize_account: {
        title: "Personalisieren Sie TaskPilot.",
  ...
  workspace_creation: {
    ...
    subheading: "Um TaskPilot verwenden zu können, müssen Sie einen Arbeitsbereich erstellen oder beitreten.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Willkommen bei TaskPilot, wir freuen uns, dass Sie hier sind. Erstellen Sie Ihr erstes Projekt, verfolgen Sie Arbeitselemente und diese Seite verwandelt sich in einen Ort für Ihren Fortschritt. Administratoren sehen hier zusätzlich teamrelevante Elemente.",
        primary_button: {
          text: "Erstes Projekt erstellen",
          comic: {
            title: "Alles beginnt mit einem Projekt in TaskPilot",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Kopieren Sie diesen Schlüssel und fügen Sie ihn in TaskPilot Pages ein. Nach dem Schließen können Sie ihn nicht mehr sehen. Eine CSV-Datei mit dem Schlüssel wurde heruntergeladen.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Verwenden Sie die API, um TaskPilot mit externen Systemen zu integrieren.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "TaskPilot wird Arbeitselemente automatisch archivieren, die abgeschlossen oder abgebrochen wurden.",
        duration: "Arbeitselemente automatisch archivieren, die seit",
      },
      "auto-close": {
        title: "Arbeitselemente automatisch schließen",
        description:
          "TaskPilot wird Arbeitselemente automatisch schließen, die nicht abgeschlossen oder abgebrochen wurden.",
  ...
  self_hosted_maintenance_message: {
    taskpilot_didnt_start_up_this_could_be_because_one_or_more_taskpilot_services_failed_to_start:
      "TaskPilot ist nicht gestartet. Dies könnte daran liegen, dass einer oder mehrere TaskPilot-Services nicht starten konnten.",
