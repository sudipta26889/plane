...
export default {
  ...
  auth: {
    common: {
      ...
      new_to_plane: "Baru di TaskPilot?",
  ...
  support: "Dukungan",
  forum: "Forum",
  powered_by_plane_pages: "Ditenagai oleh TaskPilot Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        title: "Buat proyek",
        description: "Sebagian besar hal dimulai dengan proyek di TaskPilot.",
        cta: "Mulai sekarang",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Jadikan TaskPilot milik Anda.",
  ...
  workspace_creation: {
    ...
    subheading: "Untuk mulai menggunakan TaskPilot, Anda perlu membuat atau bergabung dengan ruang kerja.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Selamat datang di TaskPilot, kami sangat senang memiliki Anda di sini. Buat proyek pertama Anda dan lacak item kerja Anda, dan halaman ini akan berubah menjadi ruang yang membantu Anda berkembang. Admin juga akan melihat item yang membantu tim mereka berkembang.",
        primary_button: {
          text: "Bangun proyek pertama Anda",
          comic: {
            title: "Segalanya dimulai dengan proyek di TaskPilot",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Salin dan simpan kunci rahasia ini di Halaman TaskPilot. Anda tidak dapat melihat kunci ini setelah Anda menekan Tutup. File CSV yang berisi kunci telah diunduh.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Setiap aplikasi yang menggunakan token ini tidak akan memiliki akses ke data TaskPilot. Tindakan ini tidak dapat dibatalkan.",
          success: {
            title: "Sukses!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "API TaskPilot dapat digunakan untuk mengintegrasikan data Anda di TaskPilot dengan sistem eksternal mana pun. Buat token untuk memulai.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Mulai dengan membuat item kerja baru! Tambahkan detail dan properti. Jelajahi lebih lanjut di TaskPilot untuk melihat aktivitas Anda.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "TaskPilot akan mengarsipkan secara otomatis item kerja yang telah selesai atau dibatalkan.",
        duration: "Arsip otomatis item kerja yang ditutup selama",
      },
      "auto-close": {
        title: "Tutup otomatis item kerja",
        description: "TaskPilot akan menutup secara otomatis item kerja yang belum selesai atau dibatalkan.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Item kerja adalah blok bangunan di TaskPilot.",
            description:
              "Mendesain ulang UI TaskPilot, Mengganti merek perusahaan, atau Meluncurkan sistem injeksi bahan bakar baru adalah contoh item kerja yang kemungkinan besar memiliki sub-item kerja.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Tulis catatan, dokumen, atau seluruh basis pengetahuan. Dapatkan Galileo, asisten AI TaskPilot, untuk membantu Anda memulai",
        description:
          "Halaman adalah ruang pemikiran di TaskPilot. Catat notul rapat, format dengan mudah, sertakan item kerja, tata letak menggunakan perpustakaan komponen, dan simpan semua di dalam konteks proyek Anda. Untuk menyelesaikan dokumen dengan cepat, panggil Galileo, AI TaskPilot, dengan pintasan atau dengan mengklik tombol.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    taskpilot_didnt_start_up_this_could_be_because_one_or_more_taskpilot_services_failed_to_start:
      "TaskPilot tidak berhasil dimulai. Ini bisa karena satu atau lebih layanan TaskPilot gagal untuk dimulai.",
