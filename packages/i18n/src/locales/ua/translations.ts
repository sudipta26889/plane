...
export default {
  ...
  auth: {
    common: {
      ...
      new_to_plane: "Вперше в TaskPilot?",
  ...
  support: "Підтримка",
  forum: "Forum",
  powered_by_plane_pages: "Працює на TaskPilot Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Більшість речей починається з проєкту в TaskPilot.",
        cta: "Почати",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Налаштуйте TaskPilot під себе.",
  ...
  workspace_creation: {
    ...
    subheading: "Щоб користуватися TaskPilot, вам потрібно створити або приєднатися до робочого простору.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Ласкаво просимо до TaskPilot, ми раді, що ви з нами. Створіть перший проєкт, додайте робочі одиниці — і ця сторінка заповниться вашим прогресом. Адміністратори побачать тут також важливі елементи для команди.",
        primary_button: {
          text: "Створіть перший проєкт",
          comic: {
            title: "Усе починається з проєкту в TaskPilot",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Скопіюйте й збережіть цей ключ для TaskPilot Pages. Після закриття ви його більше не побачите. CSV-файл із ключем було завантажено.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Використовуйте API, щоб інтегрувати TaskPilot із зовнішніми системами.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "TaskPilot архівуватиме завершені або скасовані одиниці.",
        duration: "Архівувати одиниці, закриті понад",
      },
      "auto-close": {
        title: "Автоматично закривати одиниці",
        description: "TaskPilot закриватиме неактивні одиниці.",
  ...
  self_hosted_maintenance_message: {
    taskpilot_didnt_start_up_this_could_be_because_one_or_more_taskpilot_services_failed_to_start:
      "TaskPilot не запустився. Це може бути через те, що один або декілька сервісів TaskPilot не змогли запуститися.",
  ...
  power_k: {
    ...
    help_actions: {
      ...
      open_plane_documentation: "Відкрити документацію TaskPilot",
