...
export default {
  ...
  support: "Podpora",
  forum: "Forum",
  powered_by_plane_pages: "Poháněno TaskPilot Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Většina věcí začíná projektem v TaskPilot.",
        cta: "Začít",
      },
      invite_team: {
        title: "Pozvat tým",
      ...
      personalize_account: {
        title: "Přizpůsobte si TaskPilot.",
  ...
  workspace_creation: {
    ...
    subheading: "Pro používání TaskPilot musíte vytvořit nebo se připojit k pracovnímu prostoru.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Vítejte v TaskPilot, jsme rádi, že jste zde. Vytvořte první projekt, sledujte pracovní položky a tato stránka se promění v prostor pro váš pokrok. Správci zde uvidí i položky pomáhající týmu.",
        primary_button: {
          text: "Vytvořte první projekt",
          comic: {
            title: "Vše začíná projektem v TaskPilot",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Zkopírujte a uložte tento klíč do TaskPilot Pages. Po zavření jej neuvidíte. CSV soubor s klíčem byl stažen.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Používejte API pro integraci TaskPilot s externími systémy.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "TaskPilot bude automaticky archivovat pracovní položky, které byly dokončeny nebo zrušeny.",
        duration: "Automaticky archivovat pracovní položky, které jsou uzavřené po dobu",
      },
      "auto-close": {
        title: "Automaticky uzavírat pracovní položky",
        description: "TaskPilot automaticky uzavře pracovní položky, které nebyly dokončeny nebo zrušeny.",
  ...
  self_hosted_maintenance_message: {
    taskpilot_didnt_start_up_this_could_be_because_one_or_more_taskpilot_services_failed_to_start:
      "TaskPilot se nespustil. To může být způsobeno tím, že se jeden nebo více služeb TaskPilot nepodařilo spustit.",
