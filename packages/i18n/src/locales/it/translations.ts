...
export default {
  ...
  auth: {
    common: {
      ...
      new_to_plane: "Nuovo su TaskPilot?",
  ...
  support: "Supporto",
  forum: "Forum",
  powered_by_plane_pages: "Supportato da TaskPilot Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "La maggior parte delle cose inizia con un progetto in TaskPilot.",
        cta: "Inizia",
      },
      invite_team: {
  ...
  workspace_creation: {
    ...
    subheading: "Per iniziare a usare TaskPilot, devi creare o unirti a uno spazio di lavoro.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Benvenuto in TaskPilot, siamo entusiasti di averti qui. Crea il tuo primo progetto e traccia i tuoi elementi di lavoro, e questa pagina si trasformerà in uno spazio che ti aiuta a progredire. Gli amministratori vedranno anche elementi che aiutano il team a progredire.",
        primary_button: {
          text: "Crea il tuo primo progetto",
          comic: {
            title: "Tutto inizia con un progetto in TaskPilot",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copia e salva questa chiave segreta in TaskPilot Pages. Non potrai vederla dopo aver cliccato Chiudi. È stato scaricato un file CSV contenente la chiave.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Qualsiasi applicazione che utilizza questo token non avrà più accesso ai dati di TaskPilot. Questa azione non può essere annullata.",
          success: {
            title: "Successo!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "Le API di TaskPilot possono essere utilizzate per integrare i tuoi dati in TaskPilot con qualsiasi sistema esterno. Crea un token per iniziare.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Inizia creando un nuovo elemento di lavoro! Aggiungi dettagli e proprietà ad esso. Esplora TaskPilot per vedere la tua attività.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "TaskPilot archiverà automaticamente gli elementi di lavoro che sono stati completati o annullati.",
        duration: "Archivia automaticamente gli elementi di lavoro chiusi per",
      },
      "auto-close": {
        title: "Chiudi automaticamente gli elementi di lavoro",
        description: "TaskPilot chiuderà automaticamente gli elementi di lavoro che non sono stati completati o annullati.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Gli elementi di lavoro sono i mattoni fondamentali in TaskPilot.",
            description:
              "Ridisegna l'interfaccia di TaskPilot, rebranding dell'azienda o lancia il nuovo sistema di iniezione del carburante sono esempi di elementi di lavoro che probabilmente hanno sotto-elementi.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Scrivi una nota, un documento o una vera e propria base di conoscenza. Fai partire Galileo, l'assistente AI di TaskPilot, per aiutarti a iniziare",
        description:
          "Le pagine sono spazi per appunti in TaskPilot. Prendi note durante le riunioni, formattale facilmente, inserisci elementi di lavoro, disponili usando una libreria di componenti e tienili tutti nel contesto del tuo progetto. Per velocizzare qualsiasi documento, invoca Galileo, l'IA di TaskPilot, con una scorciatoia o con il clic di un pulsante.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    taskpilot_didnt_start_up_this_could_be_because_one_or_more_taskpilot_services_failed_to_start:
      "TaskPilot non si è avviato. Questo potrebbe essere dovuto al fatto che uno o più servizi TaskPilot non sono riusciti ad avviarsi.",
