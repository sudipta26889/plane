...
import type { IPublicIssue, TIssuePublicComment, TPublicIssuesResponse } from "@taskpilot/types";
// api service
import { APIService } from "../api.service";

/**
 * Service class for managing issues within taskpilot sites application
