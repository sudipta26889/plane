...
import { CheckIcon, ViewsIcon } from "@taskpilot/propel/icons";
import { TOAST_TYPE, setToast } from "@taskpilot/propel/toast";
import type { TUserProfile } from "@taskpilot/types";
...
export const RoleSetupStep = observer(function RoleSetupStep({ handleStepChange }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-10">
      {/* Header */}
      <CommonOnboardingHeader title="What's your role?" description="Let's set up TaskPilot for how you work." />
      {/* Role Selection */}
