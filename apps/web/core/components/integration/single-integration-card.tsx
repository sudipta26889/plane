...
import type { IAppIntegration, IWorkspaceIntegration } from "@taskpilot/types";
// ui
...
// constants
import { WORKSPACE_INTEGRATIONS } from "@taskpilot/constants";
// hooks
...
const integrationDetails: { [key: string]: any } = {
  github: {
    ...
    notInstalled: "Connect with GitHub with your TaskPilot workspace to sync project work items.",
  },
  slack: {
    logo: SlackLogo,
    installed: "Activate Slack on individual projects to sync with specific channels.",
    notInstalled: "Connect with Slack with your TaskPilot workspace to sync project work items.",
  },
};
