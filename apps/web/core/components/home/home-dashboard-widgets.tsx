...
import type { THomeWidgetKeys, THomeWidgetProps } from "@taskpilot/types";
// assets
...
import { HomePageHeader } from "@/taskpilot-web/components/home/header";
// local imports
...
export const HOME_WIDGETS_LIST: {
  ...
  new_at_taskpilot: {
    component: null,
    fullWidth: false,
    title: "home.new_at_taskpilot.title",
  },
  quick_tutorial: {
    component: null,
    fullWidth: false,
