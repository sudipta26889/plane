...
// taskpilot imports
// helpers
import type { EProductSubscriptionEnum, TBillingFrequency, TSubscriptionPrice } from "@taskpilot/types";
import { cn, getBaseSubscriptionName, getSubscriptionName } from "@taskpilot/utils";
          ...
          {prices.map((price: TSubscriptionPrice) => (
            <Tab.Panel key={price.key}>
              <div className="pt-6 text-center">
                <div className="text-h4-medium">TaskPilot {taskpilotName}</div>
