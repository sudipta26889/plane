...
import { CheckIcon, CloseIcon } from "@taskpilot/propel/icons";
// components
import { LogoSpinner } from "@/components/common/logo-spinner";
import { EmptySpace, EmptySpaceItem } from "@/components/ui/empty-space";
// constants
import { WORKSPACE_INVITATION } from "@taskpilot/constants";
// helpers
        ...
        {invitationDetail && !invitationDetail.responded_at ? (
          error ? (
            ...
            <EmptySpace
              ...
              description="Your workspace is where you'll create projects, collaborate on your work items, and organize different streams of work in your TaskPilot account."
            >
          ...
          invitationDetail?.accepted ? (
            ...
            >
              ...
              <EmptySpaceItem Icon={Star} title="Star us on GitHub" href="https://github.com/taskpilot" />
              <EmptySpaceItem
                Icon={Share2}
