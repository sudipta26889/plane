      ...
      <div className="space-y-8 text-center">
        <div className="space-y-2">
          ...
          <p className="mx-auto text-13 text-secondary md:w-1/2">
            That crashed TaskPilot, pun intended. No worries, though. Our engineers have been notified. If you have more
            details, please write to{" "}
            <a href="#" className="text-accent-primary">
              Support
            </a>{" "}
            or on our{" "}
            <a href="#" target="_blank" className="text-accent-primary" rel="noopener noreferrer">
              Forum
            </a>
            .
          </p>
