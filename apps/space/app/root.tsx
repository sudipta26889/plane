...
const APP_TITLE = "TaskPilot Publish | Make your TaskPilot boards public with one-click";
const APP_DESCRIPTION = "TaskPilot Publish is a customer feedback management tool built on top of TaskPilot";
