...
import { WEB_BASE_URL } from "@taskpilot/constants";
// taskpilot internal packages
import { GithubIcon, NewTabIcon, PageIcon } from "@taskpilot/propel/icons";
...
const helpOptions = [
  ...
  {
    name: "Report a bug",
    href: "https://github.com/taskpilot/taskpilot/issues/new/choose",
    Icon: GithubIcon,
  },
];
  ...
  return (
    ...
    >
      <div className={`flex items-center gap-1 ${isSidebarCollapsed ? "flex-col justify-center" : "w-full"}`}>
        <Tooltip tooltipContent="Redirect to TaskPilot" position="right" className="ml-4" disabled={!isSidebarCollapsed}>
          <a
          ...
          >
            ...
            {!isSidebarCollapsed && "Redirect to TaskPilot"}
          </a>
        </Tooltip>
