...
import taskpilot.db.models.exporter
import taskpilot.db.models.project
import uuid
import random
import string
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "token",
                    models.CharField(
                        default=taskpilot.db.models.exporter.generate_token,
                        max_length=255,
                        unique=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        default=taskpilot.db.models.project.get_anchor,
                        max_length=255,
                        unique=True,
                    ),
                ),
                ...
                (
                    "views",
                    models.JSONField(
                        default=taskpilot.db.models.project.get_default_views
                    ),
                ),
                (
                    "created_by",
