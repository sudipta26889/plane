...
import taskpilot.db.models.api
import taskpilot.db.models.webhook
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.URLField(
                        validators=[
                            taskpilot.db.models.webhook.validate_schema,
                            taskpilot.db.models.webhook.validate_domain,
                        ]
                    ),
                ),
                ...
                (
                    "secret_key",
                    models.CharField(
                        default=taskpilot.db.models.webhook.generate_token,
                        max_length=255,
                    ),
                ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                db_index=True,
                default=taskpilot.db.models.api.generate_token,
                max_length=255,
                unique=True,
            ),
        ),
