...
# Module imports
from taskpilot.utils.html_processor import strip_tags
from taskpilot.utils.path_validator import sanitize_filename
from taskpilot.db.mixins import SoftDeletionManager, ChangeTrackerMixin
from taskpilot.utils.exception_logger import log_exception
from .project import ProjectBaseModel
from taskpilot.utils.uuid import convert_uuid_to_integer
...
class Issue(ChangeTrackerMixin, ProjectBaseModel):
    ...
    def _ensure_default_state(self):
        ...
        if self.state is not None:
            return
        try:
            from taskpilot.db.models import State
