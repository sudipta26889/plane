...
# Module imports
from taskpilot.db.models import Issue
from taskpilot.license.utils.instance_value import get_email_configuration
from taskpilot.utils.analytics_plot import build_graph_plot
from taskpilot.utils.email import generate_plain_text_from_html
...
def analytic_export_task(email, data, slug):
    try:
        ...
        logging.getLogger("taskpilot.worker").info("Email sent successfully.")
        return
