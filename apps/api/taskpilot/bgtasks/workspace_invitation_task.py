...
# Module imports
from taskpilot.db.models import User, Workspace, WorkspaceMemberInvite
...
def workspace_invitation(email, workspace_id, token, current_site, inviter):
    try:
        ...
        subject = f"{user.first_name or user.display_name or user.email} has invited you to join them in {workspace.name} on TaskPilot"  # noqa: E501
