...
from taskpilot.utils.order_queryset import ISSUE_GROUP_BY_ALLOWLIST, sanitize_order_by
...
class TestIssueGroupByAllowlist:
    ...
    `issue_group_values()` (taskpilot/utils/grouper.py and
    taskpilot/space/utils/grouper.py) knows how to resolve safely. Anything
