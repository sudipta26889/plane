...
from taskpilot.bgtasks.work_item_link_task import safe_get, validate_url_ip
...
class TestValidateUrlIp:
    ...
    def test_rejects_private_ip(self):
        with patch("taskpilot.bgtasks.work_item_link_task.socket.getaddrinfo") as mock_dns:
...
class TestValidateUrlAllowlist:
    ...
    def test_allowlist_permits_private_ip(self):
        ...
        with patch("taskpilot.utils.ip_address.socket.getaddrinfo") as mock_dns:
...
class TestSafeGet:
    ...
    mocked at the requests.Session boundary inside taskpilot.utils.url_security."""
