...
from taskpilot.middleware.db_routing import ReadReplicaRoutingMiddleware
...
class TestReadReplicaRoutingMiddleware:
    ...
    @patch("taskpilot.middleware.db_routing.set_use_read_replica")
    @patch("taskpilot.middleware.db_routing.clear_read_replica_context")
