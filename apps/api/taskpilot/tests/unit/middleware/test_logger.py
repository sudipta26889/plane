...
from taskpilot.middleware.logger import APITokenLogMiddleware
...
class TestAPITokenLogMiddleware:
    API_KEY = "taskpilot_api_supersecretvalue"
    ...
    def _captured_log_data(self, middleware, request_factory):
        ...
        with patch("taskpilot.middleware.logger.process_logs") as process_logs:
