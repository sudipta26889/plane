...
from taskpilot.db.models import Project, ProjectMember
...
class TestWorkspaceMembersLite:
    ...
    def test_returns_paginated_member(self, api_key_client, workspace, create_user):
...
class TestProjectMembersLite:
    @pytest.mark.django_db
    def test_returns_paginated_member(self, api_key_client, workspace, project, create_user):
