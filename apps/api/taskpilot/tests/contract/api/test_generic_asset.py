...
from taskpilot.db.models import FileAsset, User, Workspace, WorkspaceMember
...
def victim_user(db):
    ...
    user = User.objects.create(
        email=f"victim-{unique_id}@taskpilot.so",
...
class TestGenericAssetCrossWorkspaceIDOR:
    ...
    def test_get_cross_workspace_asset_returns_403(self, api_key_client, victim_workspace, victim_asset):
        ...
        with mock.patch("taskpilot.api.views.asset.S3Storage") as mock_storage:
