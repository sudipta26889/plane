...
from taskpilot.db.models import Issue, Project, ProjectMember, State, User
...
class TestIssueNotificationContract:
    ...
    notified the same way the web app does. See makeplane/taskpilot#9306.
    """
    ...
    def test_create_issue_triggers_notification(self, api_key_client, workspace, project):
        ...
        with patch("taskpilot.api.views.issue.issue_activity") as mock_issue_activity:
