...
```python
from taskpilot.utils.openapi.decorators import asset_docs
from taskpilot.utils.openapi.parameters import ASSET_ID_PARAMETER
from taskpilot.utils.openapi.responses import UNAUTHORIZED_RESPONSE
```
...
### Files updated:
- `taskpilot/api/views/asset.py` - All methods use new `@asset_docs` helpers
- `taskpilot/api/views/project.py` - Import updated
- `taskpilot/api/views/user.py` - Import updated  
- `taskpilot/api/views/state.py` - Import updated
- `taskpilot/api/views/intake.py` - Import updated
- `taskpilot/api/views/member.py` - Import updated
- `taskpilot/api/views/module.py` - Import updated
- `taskpilot/api/views/cycle.py` - Import updated
- `taskpilot/api/views/issue.py` - Import updated
- `taskpilot/settings/common.py` - Hook paths updated
- `taskpilot/api/apps.py` - Auth extension import updated
