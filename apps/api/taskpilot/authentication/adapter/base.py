...
from taskpilot.utils.url_security import pinned_fetch_following_redirects
...
from taskpilot.bgtasks.user_activation_email_task import user_activation_email

# Module imports
from taskpilot.db.models import FileAsset, Profile, User, WorkspaceMemberInvite
...
from taskpilot.utils.ip_address import get_client_ip
...
class Adapter:
    ...
    def __init__(self, request, provider, callback=None):
        ...
        self.user_data = None
        self.logger = logging.getLogger("taskpilot.authentication")
