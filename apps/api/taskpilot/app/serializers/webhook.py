...
from taskpilot.db.models import Webhook, WebhookLog
from taskpilot.db.models.webhook import validate_domain, validate_schema
...
class WebhookSerializer(DynamicBaseSerializer):
    ...
    def _validate_webhook_url(self, url):
        ...
        # sibling services that share a parent domain with TaskPilot.
