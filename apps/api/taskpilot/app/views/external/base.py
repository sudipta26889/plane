...
from taskpilot.app.serializers import ProjectLiteSerializer, WorkspaceLiteSerializer
from taskpilot.db.models import Project, Workspace
    ...
    api_key, provider_key, model, base_url = get_configuration_value(
        [
            ...
            },
            {
                ...
                "default": os.environ.get("LLM_API_BASE_URL", None),
            },
        ]
    )
