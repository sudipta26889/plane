...
# Module imports
from taskpilot.license.models import Instance, InstanceEdition
    ...
    def handle(self, *args, **options):
        ...
        if instance is None:
            ...
            instance = Instance.objects.create(
                instance_name="TaskPilot Community Edition",
                instance_id=secrets.token_hex(12),
                current_version=current_version,
                latest_version=current_version,
                last_checked_at=timezone.now(),
                is_test=os.environ.get("IS_TEST", "0") == "1",
                edition=InstanceEdition.TASKPILOT_COMMUNITY.value,
            )
            ...
            instance.latest_version = current_version
            instance.is_test = os.environ.get("IS_TEST", "0") == "1"
            instance.edition = InstanceEdition.TASKPILOT_COMMUNITY.value
            instance.save()
