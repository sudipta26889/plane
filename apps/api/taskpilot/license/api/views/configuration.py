...
from taskpilot.license.api.permissions import InstanceAdminPermission
from taskpilot.license.models import InstanceConfiguration
from taskpilot.license.api.serializers import InstanceConfigurationSerializer
from taskpilot.license.utils.encryption import encrypt_data
from taskpilot.utils.cache import cache_response, invalidate_cache
from taskpilot.license.utils.instance_value import get_email_configuration
...
class EmailCredentialCheckEndpoint(BaseAPIView):
    def post(self, request):
        ...
        subject = "Email Notification from TaskPilot"
        message = "This is a sample email notification sent from TaskPilot application."
        # Send the email
        try:
