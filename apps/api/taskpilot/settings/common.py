...
# Module imports
from taskpilot.utils.url import is_valid_url


BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

_logger = logging.getLogger("taskpilot")
...
# for self-hosted deployments; set to e.g. "taskpilot.so" to block specific domains.
...
INSTALLED_APPS = [
    ...
    "taskpilot.utils",
    "taskpilot.web",
    "taskpilot.middleware",
    "taskpilot.license",
    "taskpilot.api",
    "taskpilot.authentication",
    # Third-party things
    "rest_framework",
    "corsheaders",
    "django_celery_beat",
...
MIDDLEWARE = [
    ...
    "taskpilot.authentication.middleware.session.SessionMiddleware",
    ...
    "taskpilot.middleware.request_body_size.RequestBodySizeLimitMiddleware",
    "taskpilot.middleware.logger.APITokenLogMiddleware",
    "taskpilot.middleware.logger.RequestLoggerMiddleware",
]
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "taskpilot.authentication.adapter.exception.auth_exception_handler",
...
ASGI_APPLICATION = "taskpilot.asgi.application"
...
if os.environ.get("ENABLE_READ_REPLICA", "0") == "1":
    ...
    # Database Routers
    DATABASE_ROUTERS = ["taskpilot.utils.core.dbrouters.ReadReplicaRouter"]
    # Add middleware at the end for read replica routing
    MIDDLEWARE.append("taskpilot.middleware.db_routing.ReadReplicaRoutingMiddleware")
...
STORAGES["default"] = {"BACKEND": "taskpilot.settings.storage.S3Storage"}
...
CELERY_IMPORTS = (
    # scheduled tasks
    "taskpilot.bgtasks.issue_automation_task",
    "taskpilot.bgtasks.exporter_expired_task",
    "taskpilot.bgtasks.file_asset_task",
    "taskpilot.bgtasks.email_notification_task",
    "taskpilot.bgtasks.cleanup_task",
    "taskpilot.license.bgtasks.telemetry_metrics",
    # management tasks
    "taskpilot.bgtasks.dummy_data_task",
    # issue version tasks
    "taskpilot.bgtasks.issue_version_sync",
    "taskpilot.bgtasks.issue_description_version_sync",
)
...
SESSION_ENGINE = "taskpilot.db.models.session"
...
CSRF_FAILURE_VIEW = "taskpilot.authentication.views.common.csrf_failure"
